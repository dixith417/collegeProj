    ...
    const handleCommentSubmit = (values) => {
        ...
        return(
            <>
                <h3>Add Comment</h3>
                <hr />
                        <form onSubmit={(values) => handleCommentSubmit(values)}>
                            <div className="row form-group">
                                <label htmlFor="author" md={12}>Your Name</label>
                                <div className='col' md={12}>
                                    <input type='text' model=".author" 
        ...
        return(
            <div className="container">
                ...
                <div style={{display: "flex"}}>
                    ...
                    <RenderComments comments={Comments.filter(comment => comment.itemId == props.item.id)}
